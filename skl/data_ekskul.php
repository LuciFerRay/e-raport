...
<?php 
  ...
  <table border="1" class="table">
    ...
    <tr>
      ...
      <td>
        <button class="edite"><a href="edit(ekskul).php?edit=<?php echo $data['kodeeks']; ?> ">Edit</a></button>
      </td>
      <td>
        <button class="delet"><a href="hapus(ekskul).php?kodemp=<?php echo $data['kodeeks']; ?>">Hapus</a></button>   
      </td>
    </tr>
    <?php endwhile; ?>
  </table>
