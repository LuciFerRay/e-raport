...
<?php 
  ...
  <table border="1" class="table">
    ...
    <tr>
      ...
      <td>
        <button class="edite"><a href="edit(kelas).php?edit=<?php echo $data['idkelas']; ?> ">Edit</a></button>
      </td>
      <td>
        <button class="delet"><a href="hapus(kelas).php?kodemp=<?php echo $data['idkelas']; ?>">Hapus</a></button>   
      </td>
    </tr>
    <?php endwhile; ?>
  </table>
